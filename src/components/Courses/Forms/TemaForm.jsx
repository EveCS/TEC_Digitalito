  ...
  return (
    <Fragment>
      ...
      <div className="button-links">
        <button className="w-10 btn btn-primary" onClick={EditarTema}>Editar Tema </button> &nbsp; &nbsp;
        <button className="w-10 btn btn-primary" onClick={agregarTema}>Agregar Nuevo </button>
      </div>
    </Fragment>
  );
};
