...
export function ClientMenu() {
    ...
    const estudiantesEnCurso = () => {
        navigate('/estudiantesEnCurso',{state:{usuario: username}});
    };
        ...
        <Fragment>
            ...
            <div class="vh-100 p-3 mb-2 bg-dark">
                ...
                <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                    ...
                    <button onClick={estudiantesEnCurso} type="button" class="w-200 btn btn-lg btn-primary">Estudiantes en un curso</button>
